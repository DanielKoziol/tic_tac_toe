...
def initialize (board_state = new_array, move = 0, curr_player = PLAYER1)
  @move = move
...
def check_win
  ...
  board_state[line[0]] != nil && board_state[line[0]] == board_state[line[1]] && board_state[line[0]] == board_state[line[2]] ? who_won(board_state[line[0]]) : false
  end
end

def who_won(play_sign)
  win_player = play_sign == "O" ? "Player1" : "Player2"
  #p "who won"
  @winner = win_player
end
